    ...
    <div className="flex h-full flex-col overflow-hidden border-l border-border/60 bg-card">
      ...
      >
        <div className="flex items-center gap-2 overflow-hidden" style={{ color: "inherit" }}>
          ...
          <span className="rounded-sm bg-surface-overlay px-1.5 py-0.5 font-mono text-[8px] font-black uppercase tracking-tighter opacity-60">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0" style={{ color: "inherit" }}>
          ...
          <button
            ...
            className={`p-1 rounded-sm transition-opacity ${isTypePickerOpen ? "opacity-100 bg-surface-overlay-strong" : "opacity-40 hover:opacity-90"}`}
            title="Change type"
          >
