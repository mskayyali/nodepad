...
const nextConfig = {
  allowedDevOrigins: ['192.168.50.77'],
  typescript: {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://openrouter.ai https://api.openai.com https://api.z.ai http://localhost:11434 https://cloud.umami.is https://api-gateway.umami.dev",
